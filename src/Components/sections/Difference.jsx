...
export default function Difference() {
  return (
    <section
      id="difference"
      className="container mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 overflow-hidden"
    >
      ...
      <div className="relative max-w-5xl mx-auto text-center">
        {/* Glow behind section */}
        <div className="absolute inset-0 bg-blue-700/30 rounded-2xl opacity-70 filter blur-3xl z-0"></div>

        {/* Text Content Container with Neon Border */}
        <div className="relative z-10 bg-black/60 backdrop-blur-xl rounded-2xl p-8 md:p-16 border-2 border-cyan-500/50 neon-border-glow">
